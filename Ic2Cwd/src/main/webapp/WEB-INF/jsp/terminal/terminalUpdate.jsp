...
<script>
		$(document).ready(function() {
			...
			$("#btnSave").on('click',function(){
				var insertChecker = confirm('수정하시겠습니까?');
				console.log("제조사 : ");
				if(insertChecker) {
					let queryString = $("#insertForm").serialize();
					ajaxMethod('/terminal/terminalUpdate.ajax',queryString,'/terminal/terminalList.do','저장되었습니다');
			...
			<div id="work" class="work-wrap" style="padding-top: 0px;">
				...
				<div id="contents_box" class="contents_box" style="margin-top: 0px;padding-top: 5px;">
					...
					<form id="insertForm" name="insertForm" method="post" enctype="multipart/form-data">
						...
						<div class="btn_box">
							<div class="right">
								<!-- <button class="btn btn_primary" type="submit" role="button">수정</button> -->
