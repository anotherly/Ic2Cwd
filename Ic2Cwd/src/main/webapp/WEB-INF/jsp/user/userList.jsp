	...
	$(document).ready(function(){
		...
		$("#tableList").on("click", "tbody td:not(':first-child')", function(){
			...
			if(tagId!="chkTd"){
				...
				//24-10-17 : 뒤로가기 문제 해결
				location.href='/user/userDetail.do?userId=' + tagId;
			}
		});
			...
			<div id="work" class="work-wrap list_page">
                ...
                <div class="search_box">
                	<form id=searchFrm name="searchFrm" class="search_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group" >
                            <label for="sch_text_01" class="form-control-label">부서</label>
                            <input type="text" id="userDept" name="userDept" placeholder="" class="form-control">
                        </div>
                        <div class="form-group" >
