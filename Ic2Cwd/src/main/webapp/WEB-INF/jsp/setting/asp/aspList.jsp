...
<script>
	var updUrl="/setting/asp/aspUpdate.do";
	var delUrl="/setting/asp/aspDelete.ajax";
	...
	$(document).ready(function(){
		...
		$("#btnInsert").click(function() {
			location.href="/setting/asp/aspInsert.do";
		});
		...
		$("#tableList").on("click", "tbody td:not(':first-child')", function(){
			...
			if(tagId!="chkTd"){
				...
				//24-10-17 : 뒤로가기 문제 해결
				location.href='/setting/asp/aspDetail.do?userId=' + tagId;
			}
		});
	 ...
	 function search(){
		...
		if($('#dateChk').is(':checked')) { // 등록일 선택한 경우 -> 검사 후 데이터 보내기 
			...
			if(!dateChecker) { // 선택한 등록일이 올바르지 않은 경우
				...
				var tagUrl="/setting/asp/aspList.ajax";
		...
		<div id="contents" class="contents-wrap">
			...
			<div id="work" class="work-wrap list_page">
				<div class="ctn_tbl_header">
					<div class="ttl_ctn">제조사 공차/만차 관리</div>
				</div>
